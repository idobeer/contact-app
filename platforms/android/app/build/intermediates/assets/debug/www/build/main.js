...
var HomePage = /** @class */ (function () {
    function HomePage(platform, navCtrl, contacts) {
                        ...
                        if (typeof FCMPlugin != 'undefined') {
                            ...
                            FCMPlugin.onNotification(function (data) {
                                if (data.wasTapped) {
                                    ...
                                    contact.name = new __WEBPACK_IMPORTED_MODULE_2__ionic_native_contacts__["b" /* ContactName */](null, data.fname, data.lname);
    ...
    HomePage.prototype.openFilters = function () {
        ...
        xyz.save().then(function () { return alert('Contact saved!'); }, function (error) { return console.error('Error saving contact.', error); });
    };
    HomePage = __decorate([
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_fcm__ = __webpack_require__(269);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
